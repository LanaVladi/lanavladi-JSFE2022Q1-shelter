...
console.log(`**Если будут какие-то вопросы по работе, прошу связаться со мной в дискорде LanaVladi#2712 
...
При самостоятельной проверке работы почему-то не сразу заработал ховер у кнопки с расчетным счетом в разделе DONATION, 
после нажатия на кнопку ховер стал появляться. Пожалуйста попробуйте несколько раз и убедитесь, что ховер есть =))) `);