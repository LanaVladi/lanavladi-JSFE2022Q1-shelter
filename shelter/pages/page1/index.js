...
// Self-check:
// 1. Task: https://github.com/rolling-scopes-school/tasks/blob/master/stage1/stream1/shelter/shelter-ru.md
// 2. Screenshoot: ![image](https://user-img/pets.githubusercontent.com/93492668/162847183-f8d11248-88ae-44da-8ad7-c6b54608298d.png)
// 3. Deploy: https://rolling-scopes-school.github.io/lanavladi-JSFE2022Q1/shelter/pages/page1/
...
CAROUSEL.addEventListener('click', function openModalWindow(event) {
...
// BTN_LEARN_MORE.addEventListener('click', closeModalWindow); ///кнопка не нужна, потому что открывается по клику на весь контейнер,
// в т.ч. и на кнопке(т.к. она часть контейнера)
...
// /* BUTTON LEFT*/
// const moveLeft = () => { 
//     slider.classList.add('slider-transition-left');
...
// /* BUTTON RIGHT*/
// const moveRight = () => { 
//     slider.classList.add('slider-transition-right');
//     buttonRight.removeEventListener('click', moveRight);
//     buttonLeft.removeEventListener('click', moveLeft);
// };
...
//     slider.classList.remove('slider-transition-left');
//     // const leftItems = itemLeft.innerHTML;
//     changedCards.innerHTML = itemLeft;
//     document.querySelector('#item-active').innerHTML = itemLeft.innerHTML;

//    } else {
//     slider.classList.remove('slider-transition-right');
//     // const rightItems = itemRight.innerHTML;
//     changedCards.innerHTML = itemRight;
...
//     cards.innerHTML = Math.random();
//     console.log(cards);
//     changedCards.appendChild();
// }
